  ...
  >
    ...
    <div class="flex min-h-[calc(100vh-56px)]">
      ...
      <div class="flex-1 min-w-0">
        <main
          class="flex-1 min-h-screen min-w-0 bg-gray-50 px-4 py-5 dark:bg-[#0C1326] sm:px-6 print:bg-white print:p-0"
        >
          <!-- ============================== REPORT HEADER ============================== -->
          <div
          ...
          >
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                >
                  Aggregated product sales summary
                </p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-3">
              <div class="hidden text-right sm:block">
                ...
                <p class="text-lg font-black text-slate-900 dark:text-white">
                  ...
                  <span class="text-xs font-medium text-slate-400"
                    >/ {{ products ? products.length : 0 }}</span
                  >
                </p>
              </div>
              ...
              <button
                type="button"
                @click="window.print()"
                class="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-2 text-xs font-bold uppercase tracking-wide text-slate-600 transition-all hover:border-slate-300 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 print:hidden"
              >
          ...
          <!-- ============================== SUMMARY CARDS ============================== -->
          <div
            class="mb-4 grid grid-cols-2 gap-2.5 sm:grid-cols-3 lg:grid-cols-4 print:grid-cols-4 print:gap-2"
          >
            <div
              class="rounded-xl border border-slate-200/80 bg-white p-3.5 shadow-sm transition-all hover:shadow-md dark:border-slate-800 dark:bg-slate-900 print:rounded-lg print:border-slate-300 print:p-3 print:shadow-none"
            >
              <p
              ...
              >
                {{ formatNumber(productSummary?.products || 0) }}
              </h4>
              <p
            ...
            >
              ...
              >
                {{ formatNumber(productSummary?.sales || 0) }}
              </h4>
              <p
                class="text-[10px] font-medium text-slate-400 dark:text-slate-500"
              >
            ...
            >
              ...
              >
                {{ formatNumber(productSummary?.quantity || 0) }}
              </h4>
              <p
                class="text-[10px] font-medium text-slate-400 dark:text-slate-500"
              >
            ...
            <div
              class="rounded-xl border-2 border-emerald-200 bg-emerald-50/50 p-3.5 shadow-sm transition-all hover:shadow-md dark:border-emerald-800/50 dark:bg-emerald-950/20 print:rounded-lg print:border-slate-900 print:bg-white print:p-3 print:shadow-none"
            >
              <p
              ...
              <h4
                class="mt-0.5 truncate text-lg font-black text-emerald-700 dark:text-emerald-400"
              >
                ৳ {{ formatCurrency(productSummary?.amount || 0) }}
              </h4>
              <p
                class="text-[10px] font-medium text-emerald-600/70 dark:text-emerald-500/60"
              >
                Total sales revenue
              </p>
            </div>
          ...
          >
            <div class="space-y-3.5">
              ...
              >
                ...
                <span
                  v-if="searchQuery || startDate || endDate || statusFilter"
              ...
              <div class="grid grid-cols-1 gap-3 md:grid-cols-12 md:items-end">
                ...
                <div class="md:col-span-3">
                  ...
                  <input
                    type="date"
                    v-model="startDate"
                    @change="fetchProductReports(1)"
                    class="h-[42px] w-full rounded-lg border border-slate-200 bg-slate-50/50 px-3 text-sm font-medium text-slate-800 outline-none transition-all focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-500/10 dark:border-slate-700 dark:bg-slate-800/40 dark:text-slate-100 dark:focus:border-indigo-500"
                  />
                </div>
                ...
                <div class="md:col-span-4">
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      class="h-[42px] w-full rounded-lg border border-slate-200 bg-slate-50/50 pl-10 pr-4 text-sm font-medium text-slate-800 outline-none transition-all placeholder:text-slate-400 focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-500/10 dark:border-slate-700 dark:bg-slate-800/40 dark:text-slate-100"
                    />
                  </div>
                </div>
          ...
          >
            ...
            >
              <table class="w-full border-collapse text-left">
                <thead
                  class="sticky top-0 z-10 border-b border-slate-200 bg-slate-50 backdrop-blur-md dark:border-slate-800 dark:bg-slate-800/80"
                >
                  <tr>
                    <th
                      class="w-12 px-4 py-3 text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400"
                    >
                      #
                    </th>
                    <th
                      class="px-4 py-3 text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400"
                    >
                      Product Info
                    </th>
                    <th
                    ...
                    <th
                      class="px-4 py-3 text-center text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400"
                    >
                      Sale Count
                    </th>
                    <th
                      class="px-4 py-3 text-right text-[11px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400"
                    >
                      Qty Sold
                    </th>
                    <th
                ...
                <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                  ...
                  >
                    <tr
                      ...
                      :key="item?.product_id ?? item?.product?.id ?? index"
                    ...
                    >
                      ...
                      <td class="px-4 py-3 print:px-3 print:py-2">
                        <div class="flex items-center gap-2.5">
                          ...
                          <div class="min-w-0">
                            <div
                              class="max-w-[250px] truncate text-xs font-bold text-slate-900 dark:text-slate-100"
                            >
                              {{ getProductName(item) }}
                            </div>
                            <div
                      ...
                      <td
                        class="whitespace-nowrap px-4 py-3 text-right font-mono text-xs font-black text-emerald-700 dark:text-emerald-400 print:px-3 print:py-2"
                      >
                ...
                >
                  <tr>
                    ...
                    <td
                      class="px-4 py-3 text-center font-mono text-sm font-black text-indigo-700 dark:text-indigo-400 print:px-3 print:py-2"
                    >
                      {{ formatNumber(productSummary?.sales || 0) }}
                    </td>
                    <td
                    ...
                    >
                      ৳ {{ formatCurrency(productSummary?.discount || 0) }}
                    </td>
                    <td
                      class="px-4 py-3 text-right font-mono text-sm font-black text-emerald-700 dark:text-emerald-400 print:px-3 print:py-2"
                    >
                      ৳ {{ formatCurrency(productSummary?.amount || 0) }}
                    </td>
                  </tr>
          ...
          <div
            ...
            class="flex flex-col gap-2 rounded-b-xl bg-white px-4 py-3 dark:bg-slate-900 sm:flex-row sm:items-center sm:justify-between print:hidden"
          >
            ...
            <div class="flex flex-wrap items-center justify-end gap-1.5">
              <button
                ...
                @click="changePage(1)"
                :disabled="
                  pagination.page === 1 || loading || pagination.lastPage <= 1
                "
...
async function fetchProductReports(page = 1) {
  ...
  try {
    ...
    const response = await api.get("/reports/product-by-product", {
      params: {
    ...
    errorMsg.value =
      error?.response?.data?.message || "Failed to fetch product reports.";
    products.value = [];
...
function getProductName(item) {
  ...
  return product?.name || item?.product_name || item?.name || "Unknown Product";
}

function getProductSku(item) {
  const product = getProduct(item);
  return product?.sku || item?.sku || product?.code || item?.code || "-";
}
...
function getTotalQty(item) {
  return Number(item?.total_qty ?? item?.quantity ?? item?.total_quantity ?? 0);
}

function getTotalPrice(item) {
  return Number(item?.total_price ?? item?.price ?? 0);
}

function getTotalDiscount(item) {
  return Number(item?.total_discount ?? item?.discount ?? 0);
}

function getTotalAmount(item) {
  return Number(item?.total_amount ?? item?.amount ?? 0);
}
...
// Auto-trigger API refetch on date updates
watch([startDate, endDate], () => {
  fetchProductReports(1);
});

// =====================================================
// Summaries & Pagination Computations
// =====================================================
const productSummary = computed(() => {
  const list = filteredProducts.value || [];

  return {
    products: new Set(list.map((item) => item?.product_id)).size,
    quantity: list.reduce((sum, item) => sum + getTotalQty(item), 0),
    sales: list.reduce((sum, item) => sum + getSaleCount(item), 0),
    amount: list.reduce((sum, item) => sum + getTotalAmount(item), 0),
    discount: list.reduce((sum, item) => sum + getTotalDiscount(item), 0),
  };
});
...
function previousPage() {
  ...
  if (currentPage > 1) {
    fetchProductReports(currentPage - 1);
  }
}

function nextPage() {
  const currentPage = Number(pagination.value.page || 1);
  const lastPage = Number(pagination.value.lastPage || 1);
